...
class MiniPlayerClipper extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    path.lineTo(0, h);
    path.lineTo(0, (h - 46) - offset);
    path.lineTo(10, (h - 55) - offset);
    path.lineTo(w - 10, (h - 55) - offset);
    path.lineTo(w, (h - 40) - offset);
    path.lineTo(w, h);
    path.lineTo(0, h);
    path.close();
...
class AlbumDisplayClipper extends CustomClipper<Path> {
  final double offset;
  final bool cover;

  AlbumDisplayClipper({this.offset = 0, this.cover = false});
...
class ArtistDisplayClipper extends CustomClipper<Path> {
  final double offset;
  final bool cover;

  ArtistDisplayClipper({this.offset = 0, this.cover = false});
